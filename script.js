      ...
      inputs.forEach(function(input) {
        ...
        if (input.type === 'email' && value !== '') {
          ...
          if (!emailRegex.test(value)) {
            error = input.getAttribute('data-error-email') || 'Please enter a valid email address.';
            isValid = false;
          }
        }
        if (input.hasAttribute('minlength') && value !== '') {
          ...
          if (value.length < min) {
            error = input.getAttribute('data-error-minlength') || 'Minimum ' + min + ' characters required.';
            isValid = false;
          }
        }
        if (error) {
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '5af81c99-17a3-4903-a845-6a525ff76e8c',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '5af81c99-17a3-4903-a845-6a525ff76e8c';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '5af81c99-17a3-4903-a845-6a525ff76e8c';
